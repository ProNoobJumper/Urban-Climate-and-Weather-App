...
| Gemini AI     | AI Insights           | ✅ API Key            | Backend .env  | GEMINI_API_KEY                          | Google AI Studio                       | ✅ Required        |
| OpenAQ        | Air Quality Data      | ❌ No Key             | -             | -                                       | Public API                             | ✅ Active          |
